...
[![Build Status](https://travis-ci.org/leonbreedt/statik.svg?branch=master)](https://travis-ci.org/leonbreedt/statik)
...
Install the command line tool first.
	...
	go get github.com/leonbreedt/statik
...
There is also a working example under [example](https://github.com/leonbreedt/statik/tree/master/example) directory, follow the instructions to build and run it.
